<template>
  ...
  <p>
    Тег: <a class="tags__text" href="#">{{ Post.rubric }}</a>
  </p>
  <div class="text">
    <hr />
      ...
      <div v-for="comment in Comments" :key="comment.id" class="comments">
        ...
        <div class="media text-muted pt-3">
          <img
            ...
            :src="Profile[checkIndex(Profile, comment.name)].picture"
            alt=""
          />
          <p class="mb-1 ml-1 small lh-sm">
  ...
  <hr />
  <p>
    Для редактирования записи нажмите сюда -
    <a href="#">
      <i class="material-icons">build</i>
    </a>
  </p>
  <p>
    Для удаления записи нажмите сюда -
    <a id="deleter" href="#">
  ...
  methods: {
    ...
    async loadRatingPosts() {
      ...
      Object.assign(this.Rating, {
        avg:
          this.Rating.reduce((total, rating) => total + rating.rating, 0) /
          this.Rating.length,
      });
    },
